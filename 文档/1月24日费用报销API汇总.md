...
- **请求路径**: `/api/expense-reimbursement`
- **请求方法**: `POST`
- **接口描述**: 创建新的费用报销单
...
- **请求路径**: `/api/expense-reimbursement/{id}`
- **请求方法**: `GET`
- **接口描述**: 根据报销单ID获取详细信息
...
```http
DELETE /api/expense-reimbursement/1
```
...
- **请求路径**: `/api/expense-reimbursement/{id}/approve`
- **请求方法**: `POST`
- **接口描述**: 审批报销单
...
- **请求路径**: `/api/expense-reimbursement/{id}/items`
- **请求方法**: `POST`
...
- **请求路径**: `/api/expense-reimbursement/{id}/items/{itemId}`
- **请求方法**: `DELETE`
...
```http
DELETE /api/expense-reimbursement/1/items/3
```
...
- **请求路径**: `/api/expense-reimbursement/{id}/attachments`
- **请求方法**: `POST`
...
```http
POST /api/expense-reimbursement/1/attachments
...
- **请求路径**: `/api/expense-reimbursement/{id}/attachments/{attachmentId}`
- **请求方法**: `DELETE`
...
```http
DELETE /api/expense-reimbursement/1/attachments/1
```
...
- **请求路径**: `/api/expense-reimbursement/attachments/{attachmentId}/preview`
- **请求方法**: `GET`
- **接口描述**: 预览报销单附件
...
```http
GET /api/expense-reimbursement/attachments/1/preview
```

### 成功响应示例

文件内容将直接在浏览器中预览，响应头包含：

```
Content-Type: image/jpeg
Content-Disposition: inline; filename="高铁票.jpg"
```
...
- **请求路径**: `/api/expense-reimbursement/attachments/{attachmentId}/download`
- **请求方法**: `GET`
- **接口描述**: 下载报销单附件
...
```http
GET /api/expense-reimbursement/attachments/1/download
```
...
```
Content-Type: image/jpeg
Content-Disposition: attachment; filename="高铁票.jpg"
```
