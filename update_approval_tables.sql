...
ADD COLUMN `approval_attachment` varchar(4000) NULL COMMENT '审核附件' AFTER `approval_content`;
...
ADD COLUMN `approval_attachment` varchar(4000) NULL COMMENT '审核附件' AFTER `approval_title`;